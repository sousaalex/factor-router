...
Mesmo que a escolha automática ainda aponte para uma categoria **cara**, o gateway **corrige** para um modelo **intermédio** (Kimi) quando o saldo está abaixo do limiar definido. Assim garantimos um **teto de despesa** por decisão nesses cenários, sem depender apenas da “opinião” do classificador.
